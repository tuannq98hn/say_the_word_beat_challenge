...
final List<TopicMetadata> featuredMetadata = [
  TopicMetadata(
    id: 'nature',
    label: 'Nature Walk',
    icon: '🌿',
  ...
  TopicMetadata(
    ...
    label: 'Space Travel',
    icon: '🚀',
    prompt: 'Space and planets',
  ),
  TopicMetadata(
    id: 'ocean',
    label: 'Deep Blue',
    icon: '🌊',
    prompt: 'Sea creatures and ocean terms',
  ),
  TopicMetadata(
    id: 'fantasy',
    label: 'Mythical',
    icon: '🐉',
    prompt: 'Fantasy creatures and magic',
  ),
  TopicMetadata(
    id: 'jobs',
    label: 'Professions',
    icon: '👨‍⚕️',
    prompt: 'Jobs and careers',
  ),
  TopicMetadata(
    id: 'clothes',
    label: 'Fashion',
    icon: '👗',
    prompt: 'Clothing items',
  ),
  TopicMetadata(
    id: 'body',
    label: 'Body Parts',
    icon: '💪',
    prompt: 'Body parts rhyming',
  ),
];

final Map<String, Challenge> featuredData = {
