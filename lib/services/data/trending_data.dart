...
final List<TopicMetadata> trendingMetadata = [
  TopicMetadata(
    id: 'classic',
    label: 'Classic Mix',
    icon: '🎤',
    prompt: 'Classic simple English rhymes',
  ),
  TopicMetadata(
    id: 'animals',
    label: 'Animal Farm',
    icon: '🐮',
    prompt: 'Animals that rhyme',
  ),
  TopicMetadata(
    id: 'halloween',
    label: 'Spooky Vibes',
    icon: '👻',
    prompt: 'Halloween themes',
  ),
  TopicMetadata(
    id: 'food',
    label: 'Yummy Foods',
    icon: '🍔',
    prompt: 'Foods that rhyme',
  ),
  TopicMetadata(
    id: 'tech',
    label: 'Tech Life',
    icon: '💻',
    prompt: 'Technology terms',
  ),
  TopicMetadata(
    id: 'hard',
    label: 'Tongue Twisters',
    icon: '🔥',
    prompt: 'Difficult similar sounding words',
  ),
  TopicMetadata(
    id: 'viral',
    label: 'Viral Trends',
    icon: '📈',
    prompt: 'Trending social media words',
  ),
  TopicMetadata(
    id: 'slang',
    label: 'Gen Z Slang',
    icon: '😎',
    prompt: 'Modern slang words',
  ),
  TopicMetadata(
    id: 'christmas',
    label: 'Xmas Time',
    icon: '🎄',
    prompt: 'Christmas rhyming words',
  ),
  TopicMetadata(
    id: 'summer',
    label: 'Summer Fun',
    icon: '🏖️',
    prompt: 'Summer vacation words',
  ),
  TopicMetadata(
    id: 'gaming',
    label: 'Gamer Zone',
    icon: '🎮',
    prompt: 'Video game terminology',
  ),
  TopicMetadata(
    id: 'music',
    label: 'Music Genres',
    icon: '🎵',
    prompt: 'Musical instruments and styles',
  ),
];

final Map<String, Challenge> trendingData = {
