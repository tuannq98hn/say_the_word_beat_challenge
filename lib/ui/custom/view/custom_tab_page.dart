                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => const CreateWizardPage(),
                        ...
                        state.customChallenges.isEmpty
                            ...
                            : GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final challenge = state.customChallenges[index];
                                  final lastRound = challenge.rounds.isNotEmpty
                                  ...
                                  return ChallengeCard(
                                    ...
                                    backgroundImages: previewImages
                                        ...
                                        .cast<String>()
                                        .toList(),
                                    onTap: () => widget.onChallengeSelected?.call(challenge),
                                  );
                                },
                              ),
                      ],
